...
import MyDealsHistorySection from './components/MyDealHistorySection'
import MyDealsDetailsModal from './components/MyDealsDetail'
import { HbOrderResponse } from '@/types/LegacyAdapterTypes'
import MyDealsFilterModal from './components/MyDealsFilter'
...
const MyDealsScreen = () => {
	...
	const buildRequestBody = useCallback(() => {
		...
		const body: any = { userId: user?.oracleClientId }
		...
		return body
	}, [user?.oracleClientId, filters, search])
	...
	}, [search, filters, buildRequestBody])

	useEffect(() => {
		const body = buildRequestBody()
		if (body) getOrders(body)
	}, [user?.oracleClientId])
